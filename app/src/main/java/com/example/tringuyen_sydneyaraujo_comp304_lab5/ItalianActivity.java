...
public class ItalianActivity extends AppCompatActivity {
    ...
    String searchCriteria = "italian%20restaurant";
    ...
    private class getRestaurant extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(ItalianActivity.this, "Retrieving restaurant list...", Toast.LENGTH_LONG).show();
        }

        @Override
        protected void onPostExecute(Void result) {
            super.onPostExecute(result);
            ListAdapter adapter = new SimpleAdapter(ItalianActivity.this, restaurantList,
