...
public class GreekActivity extends AppCompatActivity {
    ...
    String searchCriteria = "greek%20restaurant";
    ...
    private class getRestaurant extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            // Making a r   equest to url and getting response
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(GreekActivity.this, "Retrieving restaurant list...", Toast.LENGTH_LONG).show();
        }

        @Override
        protected void onPostExecute(Void result) {
            super.onPostExecute(result);
            ListAdapter adapter = new SimpleAdapter(GreekActivity.this, restaurantList,
