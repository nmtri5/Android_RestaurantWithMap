...
public class SpanishActivity extends AppCompatActivity {
    ...
    String searchCriteria = "spanish%20restaurant";
    ...
    private class getRestaurant extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(SpanishActivity.this, "Retrieving restaurant list...", Toast.LENGTH_LONG).show();
        }

        @Override
        protected void onPostExecute(Void result) {
            super.onPostExecute(result);
            ListAdapter adapter = new SimpleAdapter(SpanishActivity.this, restaurantList,
