...
public class IndianActivity extends AppCompatActivity {
    ...
    String searchCriteria = "indian%20restaurant";
    ...
    private class getRestaurant extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(IndianActivity.this, "Retrieving restaurant list...", Toast.LENGTH_LONG).show();
        }

        @Override
        protected void onPostExecute(Void result) {
            super.onPostExecute(result);
            ListAdapter adapter = new SimpleAdapter(IndianActivity.this, restaurantList,
